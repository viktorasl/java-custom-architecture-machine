...
public class MachineController extends JFrame {
	...
	private void demo() {
		...
		ram.occupyMemory(99, 2, "STI10");
		ram.occupyMemory(99, 3, "SMOD1");
		
		ram.occupyMemory(0, 1, "STI10");
		ram.occupyMemory(0, 2, "SP800");
		...
		ram.occupyMemory(0, 10, "JE006");
		ram.occupyMemory(0, 11, "JL006");
		ram.occupyMemory(0, 12, "JG006");
